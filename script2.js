/** @type {HTMLHeadingElement} Get h2 element from the DOM */
const heading = document.getElementById('heading');
/** @type {HTMLHtmlElement} Get text div element from the DOM */
const textElement = document.getElementById('text');
/** @type {HTMLButtonElement} Get text div element from the DOM */
...
/**
 * @type {}
 * @param {index} sceneIndex Takes a particular index of a scene
 */
...
/**
 * @type {Array} scenes array holds differens objects 
 */
const scenes = [
  // Intro
  {
  ...
  { 
    id: 3,
    title: `You think you are Ronaldinho?`,
  ...
  {
    id: 5,
    title: `Get your head out of the game!`,
  ...
  {
    id: 10,
    title: `There's moore important things in life`,
